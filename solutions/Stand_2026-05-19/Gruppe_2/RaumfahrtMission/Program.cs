...
class Program
{
    static void Main(string[] args)
    {
        ...
        // TODO: explain Komet class here! with primary constructor
        var halley = new Komet(// wir könnten auch eine Komet Klasse erstellen, aber hier verwenden wir Planet für Einfachheit
        ...
        var celestialBodies = new List<Himmelskoerper> {sonne, erde, mond, halley};
        celestialBodies.Add(new Planet("Mars", 20002, 1.88, 10001));
        var mars = celestialBodies.Last();
        ...
        // structure
        var bahnen = new List<Bahndaten> {erdbahn, mondbahn, halleyBahn};
        bahnen.Add(new Bahndaten(mars, 1.88, 1.52, 0.0934)); // Bahndaten für Mars hinzufügen

        // Ausgabe
        foreach (Bahndaten bahn in bahnen)
        {
        ...
        SpeicherVisualisierer.VisualisiereSpeicher(sonne, erde, erdbahn, "String", null);
        // Optional:
